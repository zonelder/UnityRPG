...
public class ZArrow : MonoBehaviour, IDragHandler
{
    ...
    {
        _shift.trajectory.MoveKey(_keyIndex, _shift.trajectory.GetKeyTime(_keyIndex), _shift.trajectory.GetKeyPosition(_keyIndex) + new Vector3(0, 0, sensitivity * data.delta.x));
    }
